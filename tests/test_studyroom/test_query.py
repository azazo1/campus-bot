...
class StudyRoomQueryTest(unittest.TestCase):
    ...
    def test_query_roomAvailable(self):
        ...
        """
        # rooms = self.query.query_roomsAvailable("today", "普陀校区木门研究室")
        # rooms = self.query.query_roomsAvailable("tomorrow", "普陀校区玻璃门研究室")
        rooms = self.query.query_roomsAvailable("day_after_tomorrow", "闵行校区研究室")
        for room in rooms:
